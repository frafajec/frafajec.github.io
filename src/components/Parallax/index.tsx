...
class Parallax extends React.Component<IParallaxProps, IParallaxState> {
  ...
  render() {
    ...
    const parallaxCls = cn(classes.parallax, { [classes.parallaxScale]: !loaded });
    ...
    return (
      <div className={parallaxCls} style={{ transform }}>
        <div className={classes.container}>
          <img className={classes.hero} onLoad={this.onImageLoaded} src={ws1366} srcSet={srcSet} />
            ...
            <Grid item className={classes.gridItem}>
              <div className={brandCls}>
                ...
                <h3 className={classes.subtitle}>
                  <span>Web developer</span> - <span>Project manager</span>
                </h3>
              </div>
            </Grid>
          </Grid>
