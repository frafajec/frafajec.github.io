...
class Footer extends React.Component<IFooterProps, IFooterState> {
  ...
  scrollToTop = () => {
    this.scrollTo(scrollTo.top, undefined);
    GA.scrollTop();
  };
  scrollToProfile = () => {
    this.scrollTo(scrollTo.profile, this.navbarHeight);
    GA.scrollProfile();
  };
  scrollToContact = () => {
    this.scrollTo(scrollTo.contact, this.navbarHeight);
    GA.scrollContact();
  };
  scrollToExperiences = () => {
    this.scrollTo(scrollTo.experiences, this.navbarHeight);
    GA.scrollExperience();
  };
